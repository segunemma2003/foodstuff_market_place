        ...
        try {
            ...
            $formattedProducts = $products->map(function($marketProduct) {
                ...
                return [
                    ...
                    'prices' => $marketProduct->productPrices ? $marketProduct->productPrices->map(function($price) {
                        return [
                            'id' => $price->id,
        ...
        try {
            ...
            return DB::transaction(function () use ($request) {
                ...
                $order = Order::create([
                    ...
                    'delivery_latitude' => $request->delivery_latitude ?? 0,
                    'delivery_longitude' => $request->delivery_longitude ?? 0,
